// link this to package.json script, change .env to whatever database schema u want to create, eg pokemon
// run npm run init_tables to create the database, go to sql and refresh, select the database as default schema
// ##############################################################
// REQUIRE MODULES
// ##############################################################
